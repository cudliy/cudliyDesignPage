...
export default function WorkspaceDropdown(): React.ReactElement {
  ...
  return (
    <div className='relative inline-block text-left'>
      ...
      <Button variant="outline" className="flex items-center gap-2" onClick={() => setOpen(!open)}>
        Back to Workspace <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${open ? "rotate-180" : "rotate-0"}`} />
      </Button>
