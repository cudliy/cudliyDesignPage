  ...
  return (
    <div className="w-full h-screen bg-gray-50 overflow-hidden flex p-2 sm:p-4">
      ...
      style={{ 
        ...
        {/* Vertical CUDLIY Brand Text - Highly visible outline */}
        <div className="absolute left-1 sm:left-2 bottom-4 sm:bottom-8 z-10">
          <div className="transform -rotate-90 origin-bottom-left whitespace-nowrap">
            <span className="font-['Arial'] font-black tracking-tight" style={{
